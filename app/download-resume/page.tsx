...
export default function DownloadResumePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Header */}
      <header className="bg-black/80 backdrop-blur-sm border-b border-zinc-800 py-4 sticky top-0 z-10">
              ...
              <div className="bg-zinc-800 rounded-lg p-6 w-full">
                ...
                <ul className="space-y-3 text-zinc-300">
                  <li className="flex items-start">
                    ...
                    <span className="font-mono bg-zinc-700 px-2 py-1 rounded text-sm">{resumeFileName}</span>
                  </li>
                  <li className="flex items-start">
      ...
      {/* Footer */}
      <footer className="py-8 bg-zinc-950 border-t border-zinc-800 mt-auto">
